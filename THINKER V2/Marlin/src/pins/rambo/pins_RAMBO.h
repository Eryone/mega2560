...
// Servos
//
#define SERVO0_PIN          4//24/* X_MAX_PIN//22   // Motor header MX1*/
#define SERVO1_PIN         23   // Motor header MX2
#define SERVO2_PIN         -1//24   // Motor header MX3
...
//
#define SPINDLE_LASER_PWM_PIN    NoPin   // MUST BE HARDWARE PWM
#define SPINDLE_LASER_ENA_PIN NoPin   // Pin should have a pullup!
